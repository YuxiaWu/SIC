...
def parse_arguments():
    ...
    parser.add_argument("--data_dir", default = '/storage_fast/yxwu/my_slot_discovery/TEXTOIR/data_stopwd', type=str,
                        help="The input data dir. Should contain the .csv files (or other data files) for the task.")
    ...
    parser.add_argument("--pre_train", action="store_true", help="Whether do pre-train")
    parser.add_argument("--predict_k", action="store_true", help="Whether predict the K")
